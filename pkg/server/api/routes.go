...
func NewRouter(a *API) (*mux.Router, error) {
	...
	var routes = []handlers.Route{
		...
		{Method: "POST", Pattern: "/subscriptions", HandlerFunc: handlers.Auth(app, a.createSub, nil), RateLimit: true},
		{Method: "PATCH", Pattern: "/subscriptions", HandlerFunc: handlers.Auth(app, a.updateSub, nil), RateLimit: true},
		{Method: "POST", Pattern: "/webhooks/stripe", HandlerFunc: a.stripeWebhook, RateLimit: true},
		{Method: "GET", Pattern: "/subscriptions", HandlerFunc: handlers.Auth(app, a.getSub, nil), RateLimit: true},
		{Method: "GET", Pattern: "/stripe_source", HandlerFunc: handlers.Auth(app, a.getStripeSource, nil), RateLimit: true},
		{Method: "PATCH", Pattern: "/stripe_source", HandlerFunc: handlers.Auth(app, a.updateStripeSource, nil), RateLimit: true},
