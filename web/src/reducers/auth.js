...
function reduceUsers(state = initialState.user, action) {
  switch (action.type) {
...
function reducerEmailPreference(state = initialState.emailPreference, action) {
  switch (action.type) {
...
function reducerSubscription(state = initialState.subscription, action) {
  switch (action.type) {
...
function reducerSource(state = initialState.source, action) {
  switch (action.type) {
